 ...
 *
 * Creates a new encounter note with auto-numbered naming (E0001, E0002, etc.),
 * frontmatter, and embedded dataviewjs for monster management and combat tracking.
 */

export async function run(context) {
    const { app, quickAddApi } = context;
    const { inputPrompt } = quickAddApi;
