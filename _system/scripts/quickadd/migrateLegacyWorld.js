...
module.exports = async (params) => {
    try {
        ...
        const module = await importFreshModule(params.app, '_system/scripts/actions/migration/migrateLegacyWorld.js');
        await module.run({
            app: params.app,
            quickAddApi: params.quickAddApi
        });
    } catch (error) {
        console.error('Error executing migrateLegacyWorld:', error);
